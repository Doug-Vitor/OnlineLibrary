...
namespace OnlineLibrary.Data
{
    public class SeedingServices
    {
        ...
        public void SeedDb()
        {
            ...
            {
                new("Artes"),
                new("Artesanato, Casa & Estilo de Vida"),
                new("Autoajuda"),
                new("Biografias"),
                new("Ciência"),
                new("Computação & Tecnologia"),
                new("Culinária"),
                new("Drama"),
                new("Educação"),
                new("Engenharia & Transportes"),
                new("Esportes"),
                new("Ficção científica"),
                new("História"),
                new("Humor & Entretenimento"),
                new("HQ's & Mangás"),
                new("Infantil"),
                new("Medicina"),
                new("Negócios"),
                new("Outros"),
                new("Policial, Suspense & Mistério"),
                new("Política & Ciências sociais"),
                new("Relacionamentos"),
                new("Religião"),
                new("Romance"),
                new("Saúde"),
            ...
            Book[] books = {
                new("A psicologia das cores", genres[0], "Este livro aborda a relação das cores com os nossos sentimentos e mostra como as duas coisas não se combinam por acaso, já que as relações entre ambas não são apenas questões de gosto, mas sim experiências universais profundamente enraizadas na nossa linguagem e no nosso pensamento.", 113, authors[0]),
                new("Isso é arte?", genres[0], "Original, irreverente, acessível e tecnicamente impecável, Isso é arte? conduz o leitor por uma excitante viagem através de mais de 150 anos de arte moderna, do impressionismo até os dias de hoje.", 65, authors[1]),
                new("Barack Obama: Uma terra prometida", genres[3], "Um relato íntimo e fascinante da história em formação ― feito pelo líder que nos inspirou a acreditar no poder da democracia.", 54, authors[2]),
                new("Do Mil ao Milhão. Sem Cortar o Cafezinho", genres[3], null, 15.99, authors[3]),
                new("Os segredos da mente milionária", genres[17], null, 18.99, authors[4]),
                new("Domain-Driven Design", genres[5], "O design orientado a domínio é o conceito de que a estrutura e a linguagem do código do software devem corresponder ao domínio do negócio. Por exemplo, se um software processa solicitações de empréstimo, ele pode ter classes como LoanApplication e Customer e métodos como AcceptOffer e Withdraw.", 459, authors[5]),
                new("Código limpo: Habilidades práticas do Agile Software", genres[5], "Robert C. Martin, apresenta um paradigma revolucionário com Código limpo: Habilidades Práticas do Agile Software. Martin se reuniu com seus colegas do Mentor Object para destilar suas melhores e mais ágeis práticas de limpar códigos “dinamicamente” em um livro que introduzirá gradualmente dentro de você os valores da habilidade de um profissional de softwares e lhe tornar um programador melhor.", 62, authors[6]),
                new("Turma da Mônica - Clássicos Ilustrados - O Pequeno Polegar", genres[14], "Cada livro desta coleção traz um conto clássico famoso no mundo todo, representado pelas personagens da Turma da Mônica.", 9.90, authors[7]),
                new("Cebolinha - Dia das Bruxas", genres[14], null, 41, authors[7]),
                new("Vida organizada: Como definir prioridades e transformar seus sonhos em objetivos", genres[1], null, 26.90, authors[8]),
                new("Origami para crianças", genres[1], "O origami é uma arte milenar e muito conhecida. Divirta-se com este livro e aprenda a fazer muitos desenhos de origami. Use a sua criatividade para finalizar as artes.", 9.90, authors[9]),
                new("Panelinha: receitas que funcionam", genres[6], "Panelinha é o site que Rita Lobo criou no ano de 2000 para ensinar a preparar pratos saudáveis, revelando truques e manhas, de modo que qualquer pessoa consiga fazer. Para o livro, foram reunidas sugestões para variadas situações e ocasiões do cotidiano.", 83, authors[10]),
                new("Chef profissional", genres[6], "Chef profissional é essencial para qualquer chef que deseje aprender e aperfeiçoar suas técnicas. Essa bíblia dos chefs reflete, como poucas obras, a forma como as pessoas cozinham e comem, e ainda procura discutir uma vasta gama de assuntos, que vão de uma análise do trabalho do chef a capítulos específicos sobre diversos refeições.", 211, authors[11]),
                new("Questões de bolso - Polícia rodoviária federal", genres[8], "Este material, essencial para preparação, traz 1.360 questões gabaritadas das disciplinas básicas e específicas pertinentes ao concurso.O livro de bolso foi formulado para que o concurseiro possa utilizá-lo com facilidade, podendo transportá-lo durante suas atividades cotidianas, uma vez que possui um tamanho reduzido.", 19.99, authors[12]),
                new("ENEM - Exame nacional do ensino médio - Questões comentadas", genres[8], "A Editora AlfaCon reuniu profissionais especialistas comgrande experiência em ENEM e trouxe para você esta obra que inclui questões dos últimos 7 anos de prova, incluindo as do ENEM 2018. São mais de 1250 questões resolvidas e comentadas. As novidades não param por aí! O ENEM Questões 2019 AlfaCon também trás: Informações gerais sobre o exame.", 42.49, authors[12]),
                new("Estruturas de Madeira", genres[9], "Em Estruturas de Madeira, os autores apresentam os produtos de madeira e seu emprego em estruturas civis, as propriedades físicas e mecânicas da madeira e a metodologia de dimensionamento dos elementos estruturais no contexto do assim chamado método dos estados limites.", 137.99, authors[13]),
                new("Segurança nas Estruturas", genres[9], "O livro apresenta, discute e demonstra, por meio de exemplos, a evolução das teorias desenvolvidas para a introdução de segurança nas estruturas, entendendo-se segurança como a capacidade da estrutura de suportar as forças que estará submetida durante a sua vida útil.", 215, authors[14]),
                new("Enfermagem Forense", genres[24], "A Enfermagem Forense é uma área de saber e de práticas mais desenvolvida em países como Portugal, Estados Unidos e Japão. Costuma chamar a atenção dos mais variados tipos de profissionais pela sua semelhança com os seriados de ficção, que usam a perícia e a investigação para solucionar crimes, na maioria das vezes, de alta complexidade.", 148, authors[15]),
                new("Sapiens: Uma breve história da humanidade", genres[12], "Na nova edição do livro que conquistou milhões de leitores ao redor do mundo, Yuval Noah Harari questiona tudo o que sabemos sobre a trajetória humana no planeta ao explorar quem somos, como chegamos até aqui e por quais caminhos ainda poderemos seguir.", 32, authors[16]),
                new("Escravidão: Da corrida do ouro em Minas Gerais até a chegada da corte de dom João ao Brasil", genres[12], null, 34, authors[17]),
                new("Os 10 (ou mais) mandamentos da solteira", genres[13], "Como é ser jovem e solteira nos dias de hoje? Um guia de mesa de bar... ou talvez um não guia, em que os conselhos não precisam ser levados ao pé da letra, os mandamentos são flexíveis e as histórias podem ou não ser verídicas.", 22, authors[18]),
                new("Rezende Obstetrícia", genres[16], "Clássico que tem contribuído para a formação de várias gerações de estudantes e profissionais da saúde.", 407, authors[19]),
                new("Princípios de Neurociências", genres[16], "Decifrar a relação entre o encéfalo e o comportamento humano sempre foi um dos maiores desafios da ciência. Escrito por importantes pesquisadores da área, incluindo Eric R. Kandel, vencedor do Prêmio Nobel em 2000, este clássico absoluto apresenta uma visão atualizada da disciplina de neurociências, refletindo a pesquisa mais recente que transformou o conhecimento na última década.", 389, authors[20]),
                new("O Que Aconteceu Com Annie", genres[21], "Quando Joe Thorne era adolescente, sua irmã mais nova desapareceu. Vinte e cinco anos depois, um e-mail anônimo o leva mais uma vez ao passado: “Eu sei o que aconteceu com sua irmã. Está acontecendo de novo.”", 29.99, authors[21]),
                new("Um de nós está mentindo", genres[21], "Cinco alunos entram em detenção na escola e apenas quatro saem com vida. Todos são suspeitos e cada um tem algo a esconder. Este é o enredo do Um de nós está mentindo, romance de estreia de Karen M. McManus.", 29, authors[22]),
                new("Política é para todos", genres[20], null, 26.90, authors[23]),
                new("Cristianismo puro e simples", genres[22], "Lewis apresenta os principais elementos da cosmovisão cristã, gradativamente conduzindo o leitor a temas mais profundos e complexos, provocando reflexão e debate. Nesta edição especial e com tradução de uma das maiores especialistas em Lewis do Brasil, você vai encontrar as palavras que encorajaram e fortaleceram milhares de ouvintes em tempos de guerra - e ainda reverberam mais de 70 anos depois.", 18, authors[24]),
                new("O Deus que destrói sonhos", genres[22], "Uma tentação constante que cerca a vida cristã é a inversão do chamado: a presunção de que Deus precisa abençoar o meu caminho e me seguir em meus planos e sonhos. Essa postura é enganosa e faz parecer que Deus só é fiel quando me abençoa.", 22.90, authors[25]),
                new("É Assim que Acaba", genres[23], "O romance mais pessoal da carreira de Colleen Hoover, É assim que acaba discute temas como violência doméstica e abuso psicológico de forma sensível e direta.", 32, authors[26]),
                new("Teto Para Dois", genres[23], null, 37, authors[27]),
                new("Princípios de Química: Questionando a Vida Moderna e o Meio Ambiente", genres[4], "Princípios de Química: questionando a vida moderna e o meio ambiente, sétima edição, apresenta todos os fundamentos da química de forma clara e precisa, utilizando inúmeras ferramentas pedagógicas. O conteúdo está organizado em 85 tópicos curtos, distribuídos em 11 grupos temáticos.", 239.99, authors[28]),
                new("Ideias para adiar o fim do mundo", genres[4], "Uma parábola sobre os tempos atuais, por um de nossos maiores pensadores indígenas.", 15.49, authors[29]),
                new("Duna: 1", genres[11], "Duna é um triunfo da imaginação, que influenciará a literatura para sempre. Esta edição inédita, com introdução de Neil Gaiman, apresenta ao leitor o universo fantástico criado por Herbert e que será adaptado ao cinema por Denis Villeneuve, diretor de A chegada e de Blade Runner 2049.", 29.99, authors[30]),
                new("Viagem ao centro da Terra", genres[11], "O professor Lidenbrock consegue decifrar um enigma do pergaminho de um cientista do século XII e se junta ao seu sobrinho, o jovem Áxel, para checar a possibilidade de chegar ao centro da Terra seguindo o relato decifrado.", 9.95, authors[31]),
                new("Talvez você deva conversar com alguém: Uma terapeuta, o terapeuta dela e a vida de todos nós", genres[2], "De modo geral, buscamos a ajuda de um terapeuta para melhor compreender as angústias, os medos, a culpa ou quaisquer outros sentimentos que nos causam desconforto e sofrimento. Mas quantos de nós já paramos para perguntar: o terapeuta está imune à gama de questões que ele auxilia seus pacientes a dirimir e superar, dia após dia? A autora e terapeuta Lori Gottlieb nos mostra essa resposta", 29.90, authors[32]),
                new("Como Fazer Amigos e Influenciar Pessoas", genres[2], "O guia clássico e definitivo para relacionar-se com as pessoas. Como fazer amigos e influenciar pessoas segue sendo um livro inovador, e uma das principais referências do mundo sobre relacionamentos.", 45, authors[33]),
                new("Transformando suor em ouro", genres[2], "Obstinado, persistente, perfeccionista e motivador, Bernardinho se tornou o maior técnico de vôlei da história do Brasil – e um dos grandes treinadores do esporte coletivo em todo o mundo. Transformando suor em ouro é a história de Bernardinho contada por ele mesmo, desde os tempos de jogador até a consagração como técnico com o ouro olímpico.", 23, authors[34]),
                new("Federer: O Homem Que Mudou o Esporte", genres[10], null, 52, authors[35]),
                new("Na natureza selvagem", genres[25], "Narrativa verídica sobre sonhos de juventude que se transformam em pesadelo. O corpo em decomposição de um jovem é encontrado no Alasca. A polícia descobre que se trata de um rapaz de família rica do Leste americano que largou tudo, se internou sozinho na aridez gelada e morreu de inanição. Quem era o garoto? Por que foi para o Alasca? Por que morreu?", 35, authors[36])
            };
